...
// Registrar nuevo nivel académico
// ============================================================
...
// Niveles existentes para validar duplicados
$niveles_existentes = [
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Validar duplicados
    foreach ($niveles_existentes as $n) {
    ...
    <div class="dashboard-container">
        ...
        <div class="page-header">
            <div class="page-header-content">
                ...
                <div>
                    <h1 class="page-title">Registrar Nuevo Nivel Académico</h1>
                    <p class="page-subtitle">Complete los datos para registrar un nuevo nivel académico en el sistema</p>
                </div>
            </div>
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="abr_m" class="form-control" placeholder="Ej. Lic." 
                               value="<?= htmlspecialchars($_POST['abr_m'] ?? '') ?>" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="abr_f" class="form-control" placeholder="Ej. Lic." 
                               value="<?= htmlspecialchars($_POST['abr_f'] ?? '') ?>" required>
...
<style>
/* ============================================================
   ESTILOS - REGISTRO NIVEL ACADÉMICO
   ============================================================ */
